...
const PATH = "//yourltest/mediashare/src/user-apis/userinfo.php";
const NEWPROPIC = "//yourltest/mediashare/src/user-apis/upload.php";
const CHANGEIMG = "//yourltest/mediashare/src/user-apis/newprofileimg.php";
const CHANGEINFO = "//yourltest/mediashare/src/user-apis/newprofileinfo.php";
...
function Profile({user}) {
  ...
  useEffect(() => {
    ...
    .then((result) => {
      const imgAlter = "//yourltest/mediashare/src/user-apis/" + result.data.img
  ...
  useEffect(() => {
    ...
    const imgAlter = "//yourltest/mediashare/src/user-apis/" + inputs.imgpath;
